...
const AdminPanel: React.FC = () => {
  ...
  // Check if user is admin - if not, redirect to catalog
  if (user?.role !== 'admin') {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <h2 className="text-xl font-bold text-[#53565A] mb-2">Access Denied</h2>
          <p className="text-[#888B8D] mb-4">
            You don't have permission to access the admin panel. This area is restricted to administrators only.
          </p>
          <button
            onClick={() => navigate('/catalog')}
            className="bg-[#FF9E1B] text-white px-6 py-2 rounded-lg hover:bg-[#FF9E1B]/90 transition-colors"
          >
    ...
    <div className="h-screen bg-gray-50 flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full relative">
        ...
        <Button
          variant="default"
          size="sm"
          className="lg:hidden fixed top-4 right-4 z-[60] bg-[#FF9E1B] hover:bg-[#FF9E1B]/90 text-white shadow-2xl rounded-full w-14 h-14 p-0 border-2 border-white"
