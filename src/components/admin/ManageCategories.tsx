          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-[#53565A] flex items-center gap-3">
                <FolderTree className="w-8 h-8 text-[#008C95]" />
                Manage Categories
              </h1>
              <p className="text-[#888B8D] mt-1">Create, edit, and organize your product categories</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Filter className="w-5 h-5 text-[#008C95]" />
                Search Categories
              </CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              ...
              {categories.length === 0 && (
                <div className="text-center py-12">
                  <FolderTree className="w-16 h-16 text-[#888B8D] mx-auto mb-4" />
                  <h3 className="text-lg font-semibold text-[#53565A] mb-2">No categories found</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-gray-200 pb-6">
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-[#008C95]/10 rounded-lg flex items-center justify-center">
                <Plus className="w-6 h-6 text-[#008C95]" />
              </div>
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-[#53565A]">Create New Category</h1>
                <p className="text-[#888B8D] mt-1">Add a new category to organize your products</p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-gray-200 pb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-[#53565A]">Edit Category</h1>
                <p className="text-[#888B8D] mt-1">Update details for "{selectedCategory.name}"</p>
              </div>
            </div>
          </div>
          <CategoryForm 
      ...
      <Dialog open={showDeleteModal} onOpenChange={setShowDeleteModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete "{selectedCategory?.name}"? This action cannot be undone and may affect products in this category.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
