          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-[#53565A] flex items-center gap-3">
                <Package2 className="w-8 h-8 text-[#0067A0]" />
                Manage Products
              </h1>
              <p className="text-[#888B8D] mt-1">Search, filter, edit, and manage your product catalog</p>
            </div>
            ...
            <CardContent>
              ...
              {products.length === 0 && (
                <div className="text-center py-12">
                  <Package2 className="w-16 h-16 text-[#888B8D] mx-auto mb-4" />
                  <h3 className="text-lg font-semibold text-[#53565A] mb-2">No products found</h3>
                  <p className="text-[#888B8D] mb-4">Try adjusting your search or filter criteria</p>
                  <Button 
                    onClick={() => setCurrentView('create')}
                    className="bg-[#FF9E1B] hover:bg-[#FF9E1B]/90"
                  >
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-gray-200 pb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-[#53565A]">Create New Product</h1>
                <p className="text-[#888B8D] mt-1">Add a new product to your lighting catalog</p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-gray-200 pb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-[#53565A]">Edit Product</h1>
                <p className="text-[#888B8D] mt-1">Update details for "{selectedProduct.name}"</p>
              </div>
            </div>
          </div>
          <ProductForm 
